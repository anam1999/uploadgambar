...
public class DownladVideo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_downlad_video);
        ...
        ip = "192.168.43.229/uploadFiles/"; //Change this ip with your Ip
        db = "uploadvideo"; //Change this Database name with yours
        un = "root"; // Change this username with your database username
